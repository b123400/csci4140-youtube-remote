...
PlayList.prototype = {
	...
	,importVideos: function(videoIDs) {
...
Control.init = function(global) {
	...
	var $it0 = new haxe_ds__$StringMap_StringMapIterator(buttons,buttons.arrayKeys());
	while( $it0.hasNext() ) {
		var button = $it0.next();
...
var Button = function() {
	this.element = window.document.createElement("div");
	this.element.addEventListener("click",$bind(this,this.clicked));
};
